This is how we started with raspberry pi 4 Model B 8 G RAM

At first with need a SD card to install raspberry pi OS(Raspian) on it.
we go to the
https://www.raspberrypi.com/ 
and download Raspberry Pi Imager,for installing Raspian.
...
once writing is finished we put our SD card at back of our board and,
it connects to our network wich we set at previous section.
we use instructions of connecting with SSH from the link below :
